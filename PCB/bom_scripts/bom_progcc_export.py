...
"""
    ...
    Command line:
    python "pathToFile/bom_csv_grouped_extra.py" "%I" "%O" "Extra_Field1" "Extra_Field2"
"""
...
comp_fields = ['Value', 'Footprint', 'DNP', 'USBDNP', 'BTDNP'] + extra_fields
...
# instead
try:
    f = kicad_utils.open_file_writeUTF8(sys.argv[2]+'_usb.csv', 'w')
except IOError:
...
# instead
try:
    f = kicad_utils.open_file_writeUTF8(sys.argv[2]+'_bluetooth.csv', 'w')
except IOError:
    e = "Can't open output file for writing: " + sys.argv[2]
    print(__file__, ":", e, sys.stderr)
    f = sys.stdout
